...
fn calculate_move_for_desired_outcome_should_return_scissors() {
    assert_eq!(
        Move::Scissors,
        calculate_move_for_desired_outcome(&Move::Rock, Outcome::Lose)
    );
    assert_eq!(
        Move::Scissors,
        calculate_move_for_desired_outcome(&Move::Scissors, Outcome::Draw)
    );
    assert_eq!(
        Move::Scissors,
        calculate_move_for_desired_outcome(&Move::Paper, Outcome::Win)
    );
}
...
fn calculate_move_for_desired_outcome_should_return_rock() {
    assert_eq!(
        Move::Rock,
        calculate_move_for_desired_outcome(&Move::Paper, Outcome::Lose)
    );
    assert_eq!(
        Move::Rock,
        calculate_move_for_desired_outcome(&Move::Rock, Outcome::Draw)
    );
    assert_eq!(
        Move::Rock,
        calculate_move_for_desired_outcome(&Move::Scissors, Outcome::Win)
    );
}
